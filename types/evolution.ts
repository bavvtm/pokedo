...
export interface EvolutionChainSchema {
...
export interface ChainLinkSchema {
    ...
    evolves_to: ChainLinkSchema[]
}

export interface EvolutionDetailSchema {
    ...
    known_move: NamedAPIResourceSchema
...
export interface EvolutionTriggerSchema {
    /** The identifier for this resource. */
    id: number
